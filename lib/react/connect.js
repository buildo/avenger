        ...
        return function (f) {
            return _a = (function (_super) {
                    ...
                    function ConnectWrapper(props, context) {
                        ...
                        _this.state = { option: f(props, context.state.value) };
                        return _this;
                    }
                    ConnectWrapper.prototype.componentDidMount = function () {
                        var _this = this;
                        this.subscription = this.context.state
                            .subscribe(function (state) { return _this.setState(function () { return ({ option: f(_this.props, state) }); }); });
                    };
                    ...
                    ConnectWrapper.prototype.componentWillReceiveProps = function (nextProps) {
                        var _this = this;
                        this.setState(function () { return ({ option: f(nextProps, _this.context.state.value) }); });
                    };
