    ...
    return function (f) {
        return _a = (function (_super) {
                ...
                LocalWrapper.prototype.componentDidMount = function () {
                    var _this = this;
                    this.subscription = this.context.state.subscribe(function () { return _this.setState(_this.getState(_this.props)); });
                };
                ...
                LocalWrapper.prototype.read = function (state) {
                    return Option_1.fromNullable(_.get(state, [GLOBAL_LOCAL_KEY, LocalWrapper.displayName, this.instanceNamespace], {})).getOrElse(function () { return defaultState; });
                };
                LocalWrapper.prototype.transition = function (s) {
                    var _this = this;
                    this.context.transition(function (state) {
                        return _.set(Object.assign({}, state), [GLOBAL_LOCAL_KEY, LocalWrapper.displayName, _this.instanceNamespace], s);
                    });
                };
                return LocalWrapper;
            }(React.Component)),
