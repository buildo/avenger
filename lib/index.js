...
var Leaf = (function (_super) {
    ...
    Leaf.prototype.observe = function (a) {
        return this.cache.getSubject(a).filter(function (e) { return e !== INITIAL_LOADING; }).distinctUntilChanged(function (x, y) { return x.equals(y); }); // TODO remove distinctUntilChanged?
    };
...
var Composition = (function (_super) {
    ...
    Composition.prototype.observe = function (a1) {
        ...
        return this.master
            .observe(a1)
            .switchMap(function (cep1) {
            return cep1.data.fold(function () { return Observable_1.Observable.of(LOADING); }, function (p1) { return _this.slave.observe(_this.ptoa(p1, a1)); });
        })
    ...
    Composition.prototype.getPayload = function (a1) {
        var _this = this;
        return this.master.getPayload(a1).chain(function (p1) { return _this.slave.getPayload(_this.ptoa(p1, a1)); });
    };
...
var Profunctor = (function (_super) {
    __extends(Profunctor, _super);
    function Profunctor(observableFetch, a2toa1, p1top2) {
...
exports.observeAndRun = observeAndRun;
function copyArray(as) {
    return as.slice();
}
var Queries = (function () {
    ...
    Queries.prototype.observe = function (as) {
        ...
        var init = this.fetches.map(function () { return LOADING; });
        return Observable_1.Observable.merge.apply(Observable_1.Observable, observables).scan(function (acc, x) {
            if (acc[x.type].loading !== x.ce.loading) {
                var acc2 = copyArray(acc);
                acc2[x.type] = x.ce;
                return acc2;
            }
            return acc;
...
var Commands = (function () {
    ...
    Commands.prototype.run = function (a) {
        return Promise.all(this.commands.map(function (command) { return command.run(a); })).then(function (ps) {
            return Object.assign.apply(null, [{}].concat(ps));
        });
    };
    return Commands;
}());
